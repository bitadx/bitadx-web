                            ...
                            @csrf
                                <div class="tab-pane active" id="tab1">
                                    <div class="table-responsive">
                                        <div class="control-group form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Product Title"
                                                    name="product_title" required value="{{old('product_title')}}"/>
                                            </div>
                                                    ...
                                                    <div class="p-2 border mb-4">
                                                        <div class="upload-images d-flex">
                                                            <div class="multi-image-selected">
                                                                <img src="{{ asset('/common/assets/images/users/male/25.jpg') }}"
                                            ...
                                            <div class="form-group">
                                                <label class="form-label text-dark font-weight-semibold fs-16">Is Popular/Featured?</label>
                                                <select class="form-control custom-select" name="is_special">
                                                        <option value="0">Select to show on Home?</option>
                                                        <option value="1" {{old('is_special')=='1'?'Selected':''}}>Popular</option>
                                                        <option value="2" {{old('is_special')=='2'?'Selected':''}}>Featured</option>
                                                    </select>
                                            </div>
                                            <!-- <div class="form-group">
                                                <label
                                                    class="form-label text-dark font-weight-semibold fs-16">Ratings</label>
                                                <input type="number" class="form-control" name="ratings" max='5' value="{{old('ratings')}}"/>
                                            </div> -->
                                            <div class="form-group">
                                                <label
                                        ...
                                        <!--            data-placeholder="Choose Product" multiple name="related_classes[]">-->
                                        <!--            @foreach($course as $cou)-->
                                        <!--                <option value={{ $cou->id }} {{ @in_array($cou->id,old('related_classes')) ? 'selected':'' }}>{{ $cou->course_title }}-->
                                        <!--                </option>-->
                                        <!--            @endforeach-->
                                        <!--        </select>-->
                                        <!--    </div>-->
                                        ...
                                        <div class="control-group form-group">
                                            <div class="form-group">
                                                <label class="form-label text-dark font-weight-semibold fs-16">Title
                                                    (Meta Tag)</label>
                                                <input type="text" class="form-control" placeholder="Title (Meta Tag)"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    placeholder="Summary & Description (Meta Tag)" name="summary" value="{{old('summary')}}"/>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label text-dark font-weight-semibold fs-16">Keywords
                                                    (Meta Tag)</label>
                                                <input type="text" class="form-control"
                                                    placeholder="Keywords (Meta Tag)" name="keywords" value="{{old('keywords')}}"/>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group" style="display: none;">
                                                ...
                                                <textarea rows="9" class="form-control" name="extra_seo" value="{{old('extra_seo')}}">{{old('extra_seo')}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
