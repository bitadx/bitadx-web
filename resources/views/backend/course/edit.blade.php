                                        ...
                                        <div class="control-group form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control custom-select" name="is_special">
                                                        <option value="0" {{$courseById->is_special=='0'?'Selected':''}}>Common</option>
                                                        <option value="1" {{$courseById->is_special=='1'?'Selected':''}}>Popular</option>
                                                        <option value="2" {{$courseById->is_special=='2'?'Selected':''}}>Featured</option>
                                                    </select>
                                            </div>
                                            <!-- <div class="form-group">
                                                <label
                                            ...
                                            <!--    <label class="form-label text-dark font-weight-semibold fs-16">Product-->
                                            <!--        Details</label>-->
                                            <!--    <textarea class="content" name="product_details" id="product_details">{{ $courseById->course_details }}</textarea>-->
                                            <!--</div>-->
                                        </div>
                                        <div class="control-group form-group">
                                            <div class="form-group">
