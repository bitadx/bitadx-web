    ...
    <body>
        ...
        @endif
					  <div class="exnchange_box">
						  <div class="exnchange_box_item">
							  <div class="exnchange_box_item_inner">
								<div class="exnchange_box_item_inner_dropdown">
  									<span>Sell<i class="fas fa-chevron-down"></i></span>
                          ...
                          <form class="exnchange_box_item2_form" method="post" action="{{ url('sell-currency') }}">
                            @csrf
                                  ...
                                  <div class="item2_form_inner item2_form_inner2">
									  <label class="item2_form_inner_lab"><i class="fas fa-chevron-down"></i></label>
									  <input type="number" placeholder="Coin Quantity" name="amount" id="amount">
                                      <input type="text" value="sell" name="order_type" hidden>
								  </div>
