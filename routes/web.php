...
Route::get('/', [App\Http\Controllers\Frontend\IndexController::class, 'index'])->middleware('auth');
Route::get('categories/{slug?}', [App\Http\Controllers\Frontend\IndexController::class, 'categories']);
